...
export const fetchNotes = createAsyncThunk('notes/fetchNotes', async () => {
  const response = await axios.get(
    'https://to-do-list-mu-green.vercel.app/notes'
  );
...
export const createNote = createAsyncThunk(
  ...
  async (newNote) => {
    const response = await axios.post(
      'https://to-do-list-mu-green.vercel.app/note',
      newNote
    );
    return response.data;
  }
...
export const updateNote = createAsyncThunk(
  ...
  async (updatedNote) => {
    const response = await axios.put(
      `https://to-do-list-mu-green.vercel.app/note/${updatedNote.id}`,
      updatedNote
    );
    return response.data;
  }
...
export const getSingleNote = createAsyncThunk(
  ...
  async (noteId) => {
    const response = await axios.get(
      `https://to-do-list-mu-green.vercel.app/note/${noteId}`
    );
    return response.data;
  }
);
