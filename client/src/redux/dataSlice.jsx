...
export const getSingleTask = createAsyncThunk('tasks/getSingleTask', async (taskId) => {
  const response = await axios.get(`https://to-do-list-mu-green.vercel.app/task/${taskId}`);
  return response.data;
});
